    ...
    render() {
        return (
            <Wrapper>
                ...
                <MyP> 4. Na final turnieju w Counter Stirke'a zakfalifikuje się 8 drużyn.</MyP>
                ...
                <MyP> 6. Gramy na ustawieniach niskich w celu uzyskania płynności rozgrywki, a każdy proszony jest o przyniesienie ze sobą konfigurację, aby nie marnować na nią zbyt dużo czasu.</MyP>
...
const MYBlueHeader = styled(BlueHeader)`
            ...
            text-align:center;
            font-size:${(props) => props.isFZ ? '42px' : ''};
        `;
